...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="simple">
		...
		<?php echo $form->textField($model,'descripcion',array('size'=>30, 'maxlength'=>50)); ?>
    ...
    <?php echo $form->dropDownList($model, 'uso_interno', array('1'=>'SI', '0'=>'NO')); ?>
		...
		<div class="simple">
		<?php echo $form->labelEx($model,'usa_existencia'); ?>
    <?php echo $form->dropDownList($model, 'usa_existencia', array('1'=>'SI', '0'=>'NO')); ?>
		<?php echo $form->error($model,'usa_existencia'); ?>
	</div>

	<div class="simple">
		<?php echo $form->labelEx($model,'es_siembra'); ?>
    <?php echo $form->dropDownList($model, 'es_siembra', array('1'=>'SI', '0'=>'NO')); ?>
		<?php echo $form->error($model,'es_siembra'); ?>
	</div>
 ...
 // nombre lo que se quiere mostrar
	...
	<div class="simple">
		<?php echo $form->labelEx($model,'costo_anterior'); ?>
		<?php echo $form->textField($model,'costo_anterior'); ?>
		<?php echo $form->error($model,'costo_anterior'); ?>
	</div>

	<div class="simple">
		<?php echo $form->labelEx($model,'costo_actual'); ?>
		<?php echo $form->textField($model,'costo_actual'); ?>
		<?php echo $form->error($model,'costo_actual'); ?>
	</div>

	<div class="simple">
		<?php echo $form->labelEx($model,'precio_anterior'); ?>
		<?php echo $form->textField($model,'precio_anterior'); ?>
		<?php echo $form->error($model,'precio_anterior'); ?>
	</div>

	<div class="simple">
		<?php echo $form->labelEx($model,'precio_actual'); ?>
		<?php echo $form->textField($model,'precio_actual'); ?>
		<?php echo $form->error($model,'precio_actual'); ?>
	</div>
