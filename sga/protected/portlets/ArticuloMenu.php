<?php
class ArticuloMenu extends XPortlet
{
	public $title='Fichas';
	...
	public function getMenuData()
	{
		return array(
			...
			array('label'=>Yii::t('ui','Categorias'), 'items'=>array(
				array('label'=>Yii::t('ui','crear'), 'url'=>array('/categoria/create')),
				array('label'=>Yii::t('ui','Administrar'), 'url'=>array('/categoria/admin')),

			array('label'=>Yii::t('ui','Presentacion'), 'items'=>array(
				array('label'=>Yii::t('ui','crear'), 'url'=>array('/presentacion/create')),
				array('label'=>Yii::t('ui','Administrar'), 'url'=>array('/presentacion/admin')),
				
			)),

			)),
			array('label'=>Yii::t('ui','Articulos'), 'items'=>array(
				array('label'=>Yii::t('ui','crear'), 'url'=>array('/articulo/create')),
				array('label'=>Yii::t('ui','Administrar'), 'url'=>array('/articulo/admin')),
