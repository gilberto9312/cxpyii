...
if (YII::app()->user->name!="Guest")
{
	...
	$sql="SELECT saldo FROM banco where saldo > 1000000";
	$command = $conecction->createCommand($sql);
...

	{
		...
		$this->widget('zii.widgets.CMenu',array(
			...
			/*	array(
				...
				array(
					'label'=>Yii::t('ui', 'Compras'),
					'url'=>array('/gastos/index'),
					'active'=>$this->isMenuItemActive(array(
						'site'=>array('view'),
						'person'=>array('index','admin','view','update','create'),
					...
					array(
					'label'=>Yii::t('ui', 'Banco'),
					'url'=>array('/banco/index'),
					'active'=>$this->isMenuItemActive(array(
						'site'=>array('view'),
						'person'=>array('index','admin','view','update','create'),
						'lastItemClass'=>$ccsban,
						
						
					)),
				),
				array(
					'label'=>Yii::t('ui', 'Inventario'),
					'url'=>array('/articulo/index'),
					'active'=>$this->isMenuItemActive(array(
						'site'=>array('view'),
						'person'=>array('index','admin','view','update','create'),
