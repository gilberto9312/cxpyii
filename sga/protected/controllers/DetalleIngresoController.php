	...
	public function accessRules()
	{
		...
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('addTabularInputsAsTable','index','view','alpha','batch','updateYears','suggestTrabajador'),
				'users'=>array('@'),
			),
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('addTabularInputsAsTable','create','update','delete','admin'),
...
public function actions()
{
	...
	{
		$model=DetalleIngreso::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param DetalleIngreso $model the model to be validated
	 */
